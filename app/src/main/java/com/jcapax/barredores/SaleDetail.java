...
public class SaleDetail extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		chBonificacion = (CheckBox) findViewById(R.id.chBonificacion);
...
/*
						...
						if(chBonificacion.isChecked()){
							if(!soloProducto[2].equals(null)) {
								if ((soloProducto[0].trim().equals(_producto)) && (soloProducto[2].trim().equals(_bonif))) {
									aux = true;
								}
							}
						}
...
//****************************************************************
						String _compa = "";
						if (chBonificacion.isChecked()) {
							_compa = _producto + _bonif;
						} else {
							_compa = _producto + "/";
						}
						String _prod = null;
						_prod = soloProducto[0].trim() + soloProducto[2].trim();
...
//****************************************************************
					if (!aux){
						if(chBonificacion.isChecked()){
							arrayList.add(_producto + '-'+ editCantidad.getText().toString() + '-'+ "BONIF.");
						}
						else{
